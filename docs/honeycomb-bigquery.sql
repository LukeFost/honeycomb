-- GENERATED from apps/web/src/lib/bq.ts (the single source of truth) by
-- tools/chain-verify/scripts/gen-schema.ts. DO NOT EDIT BY HAND — run `pnpm gen:sql` after
-- changing bq.ts. Reflects the current env; with a clean env this is the production `honeycomb`
-- dataset (default EF mainnet addresses, refresh() Layer-1-only until BQ_ESCROW_ADDRESS is set).

-- ===========================================================================
-- Layer-1 tables — identity + reputation + refresh log
-- ===========================================================================
...
-- ===========================================================================
-- Layer-2 market tables — bounties / submissions / validations / settlements
-- ===========================================================================
...
-- ===========================================================================
-- Layer-1 trust / sybil-resistance scoring view
-- ===========================================================================
...
-- ===========================================================================
-- Refresh loop as a stored procedure — schedule with CALL `honeycomb.refresh`() — Layer 1 only (no escrow configured)
-- ===========================================================================
